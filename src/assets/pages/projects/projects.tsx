			...
			<div className="accordion" id="accordionProjects">
				...
				<div className="accordion-item">
					...
					<div className="accordion-body">
						...
						<a href="/files/projects/EldenRingWeaponAnalysis.pdf" download>EldenRingWeaponAnalysis.pdf</a><br/>
						<a href="/files/projects/EldenRingWeaponAnalysis.pbix" download>EldenRingWeaponAnalysis.pbix</a>
						<Carousel>
							<Carousel.Item>
				...
				<div className="accordion-item">
					...
					<div className="accordion-body">
						...
						<p><a href="/files/projects/TF2MapData.xlsx" download>TF2MapData.xlsx</a></p>
