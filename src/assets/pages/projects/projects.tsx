			...
			<div className="accordion" id="accordionProjects">
				...
				<div className="accordion-item">
					...
					<div className="accordion-body">
						...
						<br/>
						<p>You can view the source code for this project over on my GitHub at:</p>
						<p><a href="https://github.com/Daniel-Byrd/Portfolio-DB">https://github.com/Daniel-Byrd/Portfolio-DB</a></p>
						<Carousel>
							<Carousel.Item>
				...
				<div className="accordion-item">
					...
					<button className="accordion-button collapsed fs-1" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
						AI Development: AI Person Detection Model (Find Luigi)
					</button>
					</h2>
					...
					<div className="accordion-body">
						...
						<br/>
						<p>You can view the source code for this project over on my GitHub at:</p>
						<p><a href="https://github.com/Daniel-Byrd/Find-Luigi-AI">https://github.com/Daniel-Byrd/Find-Luigi-AI</a></p>								
						<Carousel>
							<Carousel.Item>
				...
				<div className="accordion-item">
					...
					<div className="accordion-body">
						...
						<br/>
						<p>You can view the source code for this project over on my GitHub at:</p>
						<p><a href="https://github.com/Daniel-Byrd/Personal-Storage-Site-Testing">https://github.com/Daniel-Byrd/Personal-Storage-Site-Testing</a></p>							
						<Carousel>
							<Carousel.Item>
				...
				<div className="accordion-item">
					...
					<button className="accordion-button collapsed fs-1" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
						Data Analysis: Performance and Availability Analysis (Elden Ring Item Analysis)
					</button>
					</h2>
				...
				<div className="accordion-item">
					...
					<button className="accordion-button collapsed fs-1" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
						Data Analysis: Community Involvement Analysis (TF2 Map Analysis)
					</button>
					</h2>
					...
					<div className="accordion-body">
						...
						<br/>
						<p>You can view the source code for this project over on my GitHub at:</p>
						<p><a href="https://github.com/Daniel-Byrd/TF2MapAnalysis2023">https://github.com/Daniel-Byrd/TF2MapAnalysis2023</a></p>
				...
				<div className="accordion-item">
					...
					<button className="accordion-button collapsed fs-1" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
						Data Analysis: Word Cloud Generation Project (Bad Apple Word Cloud Animation)
					</button>
					</h2>
					...
					<div className="accordion-body">
						...
						<br/>
						<p>You can view the source code for this project over on my GitHub at:</p>
						<p><a href="https://github.com/Daniel-Byrd/Bad-Apple-Word-Cloud">https://github.com/Daniel-Byrd/Bad-Apple-Word-Cloud</a></p>									
					</div>
					</div>
				</div>
